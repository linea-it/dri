...
class Filter(models.Model):
    ...
    lambda_min = models.FloatField(null=True, blank=True, verbose_name='lambda_min')
    lambda_max = models.FloatField(null=True, blank=True, verbose_name='lambda_max')
    lambda_mean = models.FloatField(null=True, blank=True, verbose_name='lambda_mean')
