...
uwsgi --socket 0.0.0.0:8000 --wsgi-file /app/dri/wsgi.py --py-autoreload 1 --static-map /django_static/rest_framework/=/app/dri/static/rest_framework --static-map /django_static/admin/=/app/dri/static/admin
