...
class Comanage:
    ...
    def get_org_identities(self, identifier: str):
        ...
        return self.request("registry/org_identities.json", {"coid": self.coid, "search.identifier": identifier})
    ...
    def get_org_identity_id(self, identifier: str):
        ...
        if len(org_identities) != 1:
            raise Exception(f"get_org_identities deveria retornar apenas um resultado mas retornou {len(org_identities)}")
    ...
    def get_org_identities_links(self, identifier: str):
        ...
        return self.request("registry/co_org_identity_links.json", {"orgidentityid": oi})
    ...
    def get_co_person_id(self, identifier: str):
        ...
        if len(identity_links) != 1:
            raise Exception(f"get_org_identities_links deveria retornar apenas um resultado mas retornou {len(identity_links)}")
    ...
    def get_emails(self, copersonid: int):
        ...
        """
        result = self.request("registry/email_addresses.json", {"copersonid":copersonid})
