...
folder are mapped to the application's root namespace, 'Catalogs'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Catalogs' in the same way
as `"Catalogs/sass/src"`.
