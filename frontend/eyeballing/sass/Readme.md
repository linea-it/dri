...
folder are mapped to the application's root namespace, 'Eyeballing'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Eyeballing"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Eyeballing' in the same way
as `"Eyeballing/sass/src"`.
