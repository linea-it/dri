Ext.define('aladin.Aladin', {
    ...
    config: {
        ...
        // Picker Mode
        pickerMode: false,
        // Evento Customizado que sera usado para ação de Picker, 
        // esse evento vai subistituir o onClick quando pickerMode=true.
        pickerEventName: 'onpicker',
    ...
    setPickerMode: function (state, eventname) {
        ...
        if (eventname) {
            me.setPickerEventName(eventname)
        }
