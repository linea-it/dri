Ext.define('visiomatic.Visiomatic', {
    ...
    /**
     * Desenha objeto de contorno
     * @param {Model/Array[ra,dec]} object - uma instancia de model com
     * atributos ra e dec ou um array com [ra, dec]
     * @return {I.GroupLayer} Return crosshair a groupLayer
     */
    drawXrayContours: function (ra, dec, options) {
        console.log("drawXrayContours")
        ...
        Ext.each(contours, function (contour) {
            ...
            // lContours.push(polygons)
        });

        layer = new l.LayerGroup(lContours);
        me.lContours = layer;
        map.addLayer(me.lContours)
