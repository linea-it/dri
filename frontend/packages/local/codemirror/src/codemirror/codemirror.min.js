...
nb(b,a.options.extraKeys,d,a)||nb(b,a.options.keyMap,d,a)}"multi"==d&&(a.state.keySeq=b);"handled"==d&&P(a,"keyHandled",a,b,c);if("handled"==d||"multi"==d)U(c),vd(a);return!!d}function Nf(a,b){var c=Jf(b,!0);return c?b.shiftKey&&!a.state.keySeq?Ub(a,"Shift-"+c,b,function(b){return Hc(a,b,!0)})||Ub(a,c,b,function(b){if("string"==typeof b?/^go[A-Z]/.test(b):b.motion)return Hc(a,b)}):Ub(a,c,b,function(b){return Hc(a,b)}):!1}function Yg(a,b,c){return Ub(a,"'"+c+"'",b,function(b){return Hc(a,b,!0)})}function Of(a){this.curOp.focus=
ta();if(!K(this,a)){B&&11>D&&27==a.keyCode&&(a.returnValue=!1);var b=a.keyCode;this.display.shift=16==b||a.shiftKey;var c=Nf(this,a);la&&(Od=c?b:null,!c&&88==b&&!Zg&&(ia?a.metaKey:a.ctrlKey)&&this.replaceSelection("",null,"cut"));18!=b||/\bCodeMirror-crosshair\b/.test(this.display.lineDiv.className)||$g(this)}}function $g(a){function b(a){18!=a.keyCode&&a.altKey||(Ta(c,"CodeMirror-crosshair"),ba(document,"keyup",b),ba(document,"mouseover",b))}var c=a.display.lineDiv;Ga(c,"CodeMirror-crosshair");w(document,
"keyup",b);w(document,"mouseover",b)}function Pf(a){16==a.keyCode&&(this.doc.sel.shift=!1);K(this,a)}function Qf(a){if(!(va(this.display,a)||K(this,a)||a.ctrlKey&&!a.altKey||ia&&a.metaKey)){var b=a.keyCode,c=a.charCode;if(la&&b==Od)Od=null,U(a);else if(!la||a.which&&!(10>a.which)||!Nf(this,a))if(b=String.fromCharCode(null==c?b:c),"\b"!=b&&!Yg(this,a,b))this.display.input.onKeyPress(a)}}function ah(a,b){var c=+new Date;if(Vb&&Vb.compare(c,a,b))return Wb=Vb=null,"triple";if(Wb&&Wb.compare(c,a,b))return Vb=
...
xa;a.rmClass=Ta;a.keyNames=Ea})(E);E.version="5.33.1";return E});