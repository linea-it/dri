Ext.define('CatalogBuilder.view.service.Api', {
    extend: 'CatalogBuilder.view.service.ApiBase',
    singleton: true,
    alternateClassName: 'Api',

    URL: {
        doLogin:       '/dri/api/api-auth/login/next=',
        downloadTable: {method:'POST', url:'/dri/api/CatalogBuilder_download/'},
        queryCRUD:     '/dri/api/CatalogBuilder_query/',
        ...
        getMyTables:   {method:'GET',  url:'/dri/api/CatalogBuilder_table/'},
        getFields:     {method:'POST', url:'/dri/api/CatalogBuilder_property/'}, // productcontent/'}, // ?pcn_product_id=25
        getQueries:    {method:'GET',  url:'/dri/api/CatalogBuilder_query/'},
        getSamples:    {method:'GET',  url:'/dri/api/CatalogBuilder_sample/'},
        getJobs:       {method:'GET',  url:'/dri/api/CatalogBuilder_job/'},
        preview:       {method:'POST', url:'/dri/api/CatalogBuilder_preview/'},
        renameTable:   {method:'PATCH', url:'/dri/api/CatalogBuilder_table/{id}/'},
        startJob:      {method:'POST', url:'/dri/api/CatalogBuilder_table/'},
        validate:      {method:'POST', url:'/dri/api/CatalogBuilder_validate/'},
    ...
    log: function(logText){
        Ext.GlobalEvents.fireEvent('eventregister','CatalogBuilder - ' + logText);
    }
});
